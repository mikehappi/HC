...
var go = true;
  ...
  // When the user scrolls down 695px from the top of the document, show the button >>>>> else if(this.scrollY>3495){nav.className = 'navbar-default';document.getElementById("topBtn").style.display = "block";document.getElementById("topBtnB").style.display = "none";})
  if(this.scrollY <695){nav.className = 'navbar-default';document.getElementById("topBtn").style.display = "none";document.getElementById("topBtnB").style.display = "none";}
  else {nav.className = 'scroll';document.getElementById("topBtn").style.display = "none";document.getElementById("topBtnB").style.display = "block";}
};
