...
var go = true;
  ...
  else if(this.scrollY>3495){nav.className = 'navbar-default';document.getElementById("topBtn").style.display = "block";document.getElementById("topBtnB").style.display = "none";}
  else {nav.className = 'scroll'; nav.className = 'navbar-default';document.getElementById("topBtnB").style.display = "block";document.getElementById("topBtn").style.display = "none";}
};
